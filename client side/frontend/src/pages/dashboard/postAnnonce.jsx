...
const PostAd = () => {
  ...
  async function onSubmit(data) {
    ...
    if (data.type !== "wanted") {
      // Validate images for non-wanted types
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="p-5 space-y-4">
                ...
                {/* Conditional Fields - Only show if NOT Wanted type */}
                {selectedType !== "wanted" && (
                  <>
                    {/* Price Input */}
                    <div>
              ...
              <div className="px-5 py-3 bg-gray-50 flex justify-end">
                <button
                  ...
                  disabled={
                    isSubmitting || 
                    !watch("title") || 
                    (selectedType !== "wanted" && uploadedImages.length === 0) ||
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      {selectedType === "wanted" ? "Post Wanted Ad" : selectedType === "sale" ? "Post For Sale" : 
                       selectedType === "trade" ? "Post For Trade" : selectedType === "rent" ? "Post For Rent" : "Upload"}
                    </>
                  )}
                </button>
              </div>
